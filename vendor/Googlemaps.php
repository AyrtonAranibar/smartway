...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyDJhVYEQxGiNDo4CYkRK0QnZJnkoiq0V9g'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	var $backgroundColor			= '#000000';						// A hex color value shown as the map background when tiles have not yet loaded as the user pans
	...
	var $center						= "-71.54572568, -16.40306478";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
